...
Step 1 (authorize):
- Connects to google_team_drive: http://localhost:3000/google_team_drive/authorize
...
- This will trigger fetch content job to pull google_team_drive contents for each source.
